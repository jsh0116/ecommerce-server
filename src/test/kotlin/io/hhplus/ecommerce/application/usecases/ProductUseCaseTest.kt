...
class ProductUseCaseTest {
    ...
    inner class GetProductTest {
        ...
        fun `존재하지 않는 상품은 null을 반환한다`() {
            // Given
            every { productService.getByIdOrNull(999L) } returns null
    ...
    inner class GetProductsTest {
        ...
        fun `전체 상품을 조회할 수 있다`() {
            ...
            every { productService.findAll(null, "newest") } returns products
        ...
        fun `카테고리별 상품을 조회할 수 있다`() {
            ...
            every { productService.findAll("의류", "newest") } returns categoryProducts
        ...
        fun `캐시 미스 시 DB에서 조회한다`() {
            ...
            verify { productService.findAll(null, "newest") }
        }
    }
    ...
    inner class GetTopSellingProductsTest {
        ...
        fun `최근 판매 상품을 조회할 수 있다`() {
            ...
            every { productService.findTopSelling(any(), 5) } returns sellingProducts
