...
class DtoSerializationTest {
    ...
    @Nested
    @DisplayName("ProductDto 직렬화 테스트")
    inner class ProductDtoSerializationTest {
        @Test
    ...
    @Nested
    @DisplayName("ProductDetailResponse 직렬화 테스트")
    inner class ProductDetailResponseSerializationTest {
        @Test
    ...
    @Nested
    @DisplayName("PaginationInfo 직렬화 테스트")
    inner class PaginationInfoSerializationTest {
        @Test
